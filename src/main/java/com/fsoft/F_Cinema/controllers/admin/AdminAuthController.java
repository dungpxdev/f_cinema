...
public class AdminAuthController {
	...
	public String register(@Valid UserDTO userDTO) {
		try {
			 ...
			 * userDTO.setCreatedDate(new Date()); RoleDTO roleDTO = new RoleDTO();
			 * Set<String> roles = new HashSet<String>();
			 * roleDTO.setCode(RoleConstant.SCHEDULE_MANAGER.getValue());
			 * roleDTO.setName(RoleConstant.SCHEDULE_MANAGER.getKey());
			 * userDTO.setRoles(roles); userService.save(converter.convertTo(userDTO));
			 * StringBuilder message = new StringBuilder("Save new user: ");
			 * message.append(userDTO.getEmail()); logger.info(message.toString());
			 */
